...
const calculateRiskScore = async (data) => {
    ...
    const explanation = await (0, geminiClient_1.generateContent)(`Explain real risk factors for route ${route} with ${weather} weather, ${traffic}% traffic congestion, and ${timeOfDay} time. Risk score: ${score}.`);
    return {
        score,
        level,
        explanation,
